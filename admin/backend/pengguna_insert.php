...
// $lol=move_uploaded_file($file_tmp, 'foto/'.$foto_nama);
...
$level=$_POST['level'];
      ...
      if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
				if($ukuran < 1044070){			
          // move_uploaded_file($file_tmp, 'backend/foto/pengguna-'.date('dmYgis').$foto_nama);
          move_uploaded_file($file_tmp, 'backend/foto/'.$namanya);
